...
print("\n****************WELCOME TO YOUR PERSONAL AIRLINE BOOKING SYSTEM*******************")

user = input("\nHAVE YOU CREATED AN ACCOUNT? (Y/N)")
emails = []
if user=='y' or user=='yes' or user=='Y' or user=='YES':
    ...
    password = input("\nENTER YOUR PASSWORD:-")
    print()
    print(f"OTP SEND TO {tel} AND {email_id}")
    ot = int(input("\nENTER THE OTP NO:-"))
...
print(f"\nYOUR TICKETS ARE SEND TO YOUR EMAIL {emails[0]} ")
print("\nSEE YOU LATER :)")
